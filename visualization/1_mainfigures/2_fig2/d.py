...
def d(base_directories, output_path, output_filename, csv_files, xtick_onlyone=False):
    ...
    fig.supxlabel( 'Wavenumber $(cm^{-1})$', fontproperties=font_properties_label, x=0.5,y=0.04)
    fig.supylabel( 'Absorbance $(a.u.)$', fontproperties=font_properties_label, x=0.04,y=0.52)
...
if __name__ == "__main__":
    ...
    fig_d, (ax_d1, ax_d2, ax_d3) = d(
        ...
        csv_files=csv_files,
        xtick_onlyone=True  # Set your preferred value here
    )