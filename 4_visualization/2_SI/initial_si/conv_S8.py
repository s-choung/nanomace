...
df = pd.read_excel(file_path, sheet_name='Fig. S8', skiprows=1)
print(df)
def plot_co_conversion(df):
    ...
    for i, label in enumerate(labels):
        ...
        plt.scatter(x, y, color='black', s=100, marker='o', linewidth=1.5, zorder=2-0.1*i)
    ...
    plt.savefig(f'./1_pngs/Fig. S8.png', dpi=200)
    plt.show()
